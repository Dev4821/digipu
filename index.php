...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha512-... "></link>
    ...
    <div class="firstSec">
      ...
      <div class="firstSectionContainer" id="firstSectionContainer">
        <h1 class="DigitusLogo">
          <a href="index.php"
            ><img
              src="./assets/digituslogo/mainlogo.png"
              class="logoImage"
              alt="Digitus"
  ...
  $(document).ready(function(){
    ...
    <div class="secondSection">
      ...
      >
        ...
        <div
          class="secondSecDescriptionContainer"
          data-aos="fade-up"
          data-aos-duration="900"
        >
          ...
          <div class="secDescSec" onclick="showCircleDiv('secDesc1')">
            <div class="secDescHeader">Advice</div>
            <div class="secondCircleDesc activeCircle" id="secDesc1">
              <div class="secDescText">
                Through a technical-functional audit our experts diagnose your
                information systems and configurations.
              </div>
              <div class="secDescText">
                At the end of this study, we establish a structured report
                accompanied by an action plan to respond to your Electronic Data
                Exchange challenges.
              </div>
              <div class="secDescText">
                Digitus offers you certified EDI solutions, perfectly suited to
                your most specific needs and projects.
              </div>
          ...
          <div class="secDescSec" onclick="showCircleDiv('secDesc2')">
            <div class="secDescHeader">Accompaniment</div>
            <div class="secondCircleDesc" id="secDesc2">
              <div class="secDescText">
                Regardless of your solution, installed or not by EsaLink, we
                offer several assistance models for the resolution or prevention
                of your incidents.
              </div>
              <div class="secDescText">
                Regardless of your solution, installed or not by EsaLink, we
          ...
          <div class="secDescSec" onclick="showCircleDiv('secDesc3')">
            <div class="secDescHeader">Integration</div>
            <div class="secondCircleDesc" id="secDesc3">
              <div class="secDescText">
                SaaS (private Cloud) or On Premise model, we install, configure
                or migrate your solution in the most optimal way.
              </div>
              <div class="secDescText">
                Our EDI experts integrate the modules in perfect symbiosis with
                your infrastructure and your ecosystem.
              </div>
              <div class="secDescText">
                We test and apply all sensitive connections and adjustments that
                allow you to achieve complete satisfaction with your solution.
              </div>
              <div class="circleButtonCont">
    ...
    <div
      class="buildingCorousalConatiner"
      data-aos="fade-up"
      data-aos-duration="900"
    >
      <div
        class="corusalHeaderAndCorusalContainer"
        data-aos="fade-up"
        data-aos-duration="900"
      >
            ...
            <div class="carousel-inner">
              <div class="carousel-item">
                <img
                  ...
                  src="./assets/images/IMAGES/corousalImages/img3.webp"
                  alt="Image 1"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img2.svg"
                  alt="Image 2"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img1.svg"
                  alt="Image 3"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img4.webp"
                  alt="Image 4"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img5.webp"
                  alt="Image 5"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img6.webp"
                  alt="Image 6"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img7.svg"
                  alt="Image 7"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img8.svg"
                  alt="Image 8"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img9.webp"
                  alt="Image 9"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img10.webp"
                  alt="Image 10"
                />
              </div>
              <div class="carousel-item">
                <img
                  class="carousel-image"
                  src="./assets/images/IMAGES/corousalImages/img11.webp"
                  alt="Image 11"
                />
              </div>
    ...
    <div class="navSecondSection">
      ...
      <span class="learnMoreButton" data-aos="fade-up" data-aos-duration="200"
        >Learn more</span
      >
      <div class="laptopBackgroundContainer">
        <div
          class="nonScreenTextCont"
        ...
        >
          <img
            class="screenImage"
            src="./assets/images/screens_3500x1500.webp"
            alt=""
          />
        </div>
      </div>
        ...
        >
          <div class="cardsForThirdSection">
            <div class="iconContThird">
              <img
                class="thirdCardIcons"
                src="./assets/images/IMAGES/searchIcon.png"
                alt=""
              />
            </div>
          ...
          >
            <div class="iconContThird">
              <img
                class="thirdCardIcons"
                src="./assets/images/IMAGES/pencilIcon.png"
                alt=""
              />
            </div>
          ...
          >
            <div class="iconContThird">
              <img
                class="thirdCardIcons"
                src="./assets/images/IMAGES/clockIcon.png"
                alt=""
              />
            </div>
      ...
      <div class="fourthSectionContainer">
        ...
        <div class="circleContainer">
          <div
            class="circleSectionCards"
            data-aos="fade-down"
            data-aos-duration="900"
          >
            <div class="circleForIcons greenBack">
              <img
                class="fourthIconContainer"
                src="./assets/images/IMAGES/books.svg"
                alt=""
              />
            </div>
            <div
          ...
          >
            <div class="circleForIcons yellowBack">
              <img
                class="fourthIconContainer"
                src="./assets/images/IMAGES/buildings.svg"
                alt=""
              />
            </div>
            <div
          ...
          >
            <div class="circleForIcons redBack">
              <img
                class="fourthIconContainer"
                src="./assets/images/IMAGES/graph.svg"
                alt=""
              />
            </div>
            <div
    ...
    <div class="secondHomePageSection">
      <div
        class="secondSectionHeaderContainer"
        data-aos="zoom-in-up"
        data-aos-duration="900"
      >
        <div>Need</div>
      ...
      <div class="secondSectionCorousalContainer">
        <div class="corosalContainer">
          <div class="corousalItem" id="corousal1">
            <img
              class="corusalImage"
              src="./assets/images/IMAGES/corousal1.webp"
              alt=""
            />
            <div class="corousalImageContent">
              ...
              <div class="corousalBottomContent">
                <img
                  class="toBeVanished21"
                  src="./assets/images/IMAGES/IBM.svg"
                  alt=""
                />
                ...
                <img
                  class="circleImageForCrousal toBeVanished21"
                  src="./assets/images/IMAGES/circle.svg"
                  alt=""
                />
              </div>
            </div>
          ...
          <div class="corousalItem" id="corousal2">
            <img
              class="corusalImage"
              src="./assets/images/IMAGES/corousal2.webp"
              alt=""
            />
            <div class="corousalImageContent">
              ...
              <div class="corousalBottomContent">
                <img
                  class="toBeVanished22"
                  src="./assets/images/IMAGES/CLEO.svg"
                  alt=""
                />
                ...
                <img
                  class="circleImageForCrousal toBeVanished22"
                  src="./assets/images/IMAGES/circle.svg"
                  alt=""
                />
              </div>
          ...
          <div class="corousalItem" id="corousal3">
            <img
              class="corusalImage"
              src="./assets/images/IMAGES/corousal3.webp"
              alt=""
            />
            <div class="corousalImageContent">
              <img
                class="toBeVanished3"
                src="./assets/images/IMAGES/GENERIX.svg"
                alt=""
              />
              <div class="textForCorusalImage toBeVanished3">TradeXpress</div>
              <div class="corousalBottomContent">
                <img
                  class="toBeVanished23"
                  src="./assets/images/IMAGES/GENERIX.svg"
                  alt=""
                />
                ...
                <img
                  class="circleImageForCrousal toBeVanished23"
                  src="./assets/images/IMAGES/circle.svg"
                  alt=""
                />
              </div>
